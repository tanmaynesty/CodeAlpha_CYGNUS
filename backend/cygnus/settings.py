...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-t6q9^4u98z_45@y7^0r33v58=s6%s$18d8g7m^0g^k%c-p8z^x')
...
# Client folder is at the same level as backend/
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = os.getenv('EMAIL_HOST_USER', 'tanmaynesty@gmail.com')
